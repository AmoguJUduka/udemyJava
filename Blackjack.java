...
public class Blackjack {
    ...
    public static void main(String[] args) {
        ...
        String card1 = cardNumber(num1);
        String card2 = cardNumber(num2);
        ...
        int num4 = drawrandomCard();
        String card3 = cardNumber(num4);
        String card4 = faceDown();
     ...
     */
    public static String cardNumber(int a){
        switch(a){
        case 1:   
        return "   _____\n"+
        "  |A _  |\n"+ 
